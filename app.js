...
function addItem(e) {
  ...
  // give unique IDs to items created this comes automatically with APIs and databases
...
function addToLocalStorage(id, value) {
  // console.log('added to local stotage');
...
function createListItem(id, value) {
  ...
  // append element to list element (append child)
  list.append(element);
}
